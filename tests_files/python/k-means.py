...
parser.add_argument("-q",
                    help="quiet mode: if set, does not output the clusters content (the \"clusters\" column is simply not present in the csv)")
parser.add_argument("-t", help="only used for test mode")
...
if str(args.distance) == "euclidean":
